...
% Formatting
\setmainfont{Times New Roman} % Changed to standard font for compatibility if not using TeX Gyre
\setsansfont{Arial}
...
\begin{titlepage}
    ...
    \includegraphics[height=3cm]{images/logo_bk.png} % Ensure this logo exists or remove
